                      ...
                      <div class="col-lg-6">
                        <div class="row mb-4">
                          <div class="col-lg-6">
                            ...
                            <Field class="formInput" name="name" placeholder="John Doe" type="text" :rules="validateName" />
                          ...
                          <div class="col-lg-6">
                            ...
                            <Field class="formInput" name="nickname" placeholder="John1996" type="text" :rules="validateName" />
                            <ErrorMessage class="error_input" name="nickname" />
                          </div>
                        </div>
                        <div class="inputBlock mb-4">
                          ...
                          <Field class="formInput" name="short_bio" placeholder="Max 110 characters" type="text" :rules="validateName" />
                        ...
                        <div class="inputBlock mb-4">
                          ...
                          <Field class="formInput" name="contact_info" placeholder="(999) 999-99-99 testtest@testmail.com" type="text" :rules="validateName" />
                      ...
                      <div class="col-lg-6">
                        <div class="row">
                          <div class="col-lg-12">
                            ...
                            <Field v-slot="{ field }" name="tag-0" type="checkbox" value="on">
                              <label class=" labelCheckPopup d-flex justify-content-between align-items-center mb-4 pr-0 pr-lg-4">
                                <input type="checkbox" name="tag-0" class="d-none" v-bind="field" value="on" />
                                ...
                                <div class="inputBlock checkInputOn">
                                  <Field class="formInput" name="price-tag-0" placeholder="1-5%" type="text"  />
                                </div>
                              </label>
                            </Field>

                            <Field v-slot="{ field }" name="tag-1" type="checkbox" value="on">
                              <label class=" labelCheckPopup d-flex justify-content-between align-items-center mb-4 pr-0 pr-lg-4">
                                <input type="checkbox" name="tag-1" class="d-none" v-bind="field" value="on" />
                                <div class="color-2 f-18 mr-3 mwi-100">
                                  Finance
                                </div>
                                <div class="checkArrow">
                                ...
                                <div class="inputBlock checkInputOn">
                                  <Field class="formInput" name="price-tag-1" placeholder="" type="text"  />
                                </div>
                              </label>
                            </Field>
                            <Field v-slot="{ field }" name="tag-2" type="checkbox" value="on">
                              <label class=" labelCheckPopup d-flex justify-content-between align-items-center mb-4 pr-0 pr-lg-4">
                                <input type="checkbox" name="tag-2" class="d-none" v-bind="field" value="on" />
                                <div class="color-2 f-18 mr-3 mwi-100">
                                  Insurance
                                </div>
                                <div class="checkArrow">
                                ...
                                <div class="inputBlock checkInputOn">
                                  <Field class="formInput" name="price-tag-2" placeholder="" type="text"  />
                                </div>
                              </label>
                            </Field>
                            <Field v-slot="{ field }" name="tag-3" type="checkbox" value="on">
                              <label class=" labelCheckPopup d-flex justify-content-between align-items-center mb-4 pr-0 pr-lg-4">
                                <input type="checkbox" name="tag-3" class="d-none" v-bind="field" value="on" />
                                <div class="color-2 f-18 mr-3 mwi-100">
                                  Real estate
                                </div>
                                <div class="checkArrow">
                                ...
                                <div class="inputBlock checkInputOn">
                                  <Field class="formInput" name="price-tag-3" placeholder="" type="text"  />
                                </div>
                              </label>
                            </Field>
                          </div>
...
export default {
  ...
  methods: {
    ...
    onSubmit(values) {
      ...
      var url = "https://testnet.arbstore.org/api/v1/3c20fa2bd708e4749938059dbac59ceb5253e07f679e85";
      ...
      for ( let leng of this.languages){
        formData.append('languages[]', leng);
      }
